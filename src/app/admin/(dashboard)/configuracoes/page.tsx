...
export default async function ConfiguracoesPage({ searchParams }: { searchParams: Promise<{ salvo?: string; erro?: string }> }) {
  ...
  return <div className="mx-auto max-w-4xl space-y-6">
    ...
    <form action={updateRestaurantSettingsAction} className="grid gap-5 rounded-2xl bg-white p-6 md:grid-cols-2">
      ...
      <button className="rounded-xl bg-flame px-6 py-4 font-bold text-white md:col-span-2">Salvar configurações</button>
    </form>
  </div>;
}
